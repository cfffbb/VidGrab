<template>
  <section id="platforms" class="py-16 sm:py-20 bg-bg-main" aria-labelledby="platforms-heading">
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="text-center mb-12">
        <h2 id="platforms-heading" class="text-2xl sm:text-3xl font-bold text-text-primary mb-3">
          支持全球 <span class="gradient-text">1800+</span> 视频平台下载
        </h2>
      ...
      <div class="flex flex-wrap justify-center gap-3 sm:gap-4 max-w-4xl mx-auto">
        <div
          ...
          :key="platform.name"
          class="inline-flex items-center gap-2 px-4 sm:px-5 py-2.5 bg-bg-card rounded-full border border-border hover:border-primary transition-all cursor-default"
        >
